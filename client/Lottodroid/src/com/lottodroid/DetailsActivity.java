 ...
 * 
 * It is currently constructed on top of a {@link ExpandableListActivity}, and
 * populated with toy data that is displayed as a simple {@code TextView} inside
 * a list.
 */
public class DetailsActivity extends ExpandableListActivity {
  ...
  private final static String GROUP_CELLS[] = { "05/03/2009", "06/03/2009", "07/03/2009",
      "08/03/2009" };
  private final static String CHILD_CELLS[] = { "N� 1 2 3 4 5 6, C: 2, R: 3",
      "N� 5 7 8 9 8 4, C: 4, R: 8", "N� 6 7 3 0 1 0, C: 3, R: 1", "N� 8 9 0 5 2 6, C: 8, R: 0" };
  ...
  /**
   * Construct the list of groups. They are represented as a map, where all the
   * keys are {@link #GROUP_KEY}. I don't really understand why it has to be
   * like that.
   * 
   ...
   * 
   * The return type is pretty complex, but it is what
   * {@link SimpleExpandableListAdapter} expects: every group contains a list of
   * maps. Every of those maps, which are {@code <String, List>} correspond to a
   * visible row once the group is expanded: every element in that list
   * corresponds to a row in the expanded view of the group cell. Yes, it is a
   * mess.
   * 
